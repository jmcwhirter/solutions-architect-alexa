...
def get_welcome_response():
    ...
    session_attributes = {}
    card_title = "Welcome"
    speech_output = "Welcome to the solutions architect skill. " \
                    "Feel free to ask me common questions about Sage Maker."
    # If the user either does not reply to the welcome message or says something
    # that is not understood, they will be prompted again with this text.
    reprompt_text = "Please ask me a question about Sage Maker such as, " \
...
def handle_session_end_request():
    ...
    speech_output = "Thank you for your questions. " \
                    "Have a nice day! "
...
def ask_question(intent, session):
    ...
    if 'question' in intent['slots']:
        ...
        output=runtime.invoke_endpoint(EndpointName = os.environ['endpointName'],
                               Body=question_payload_json,
